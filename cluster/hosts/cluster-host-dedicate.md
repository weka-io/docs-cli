```
Usage:
cluster host dedicate <host-id> <on> [--HOST HOST] [--PORT PORT] [--json] [--NO-HUMAN]

Description:
    Set the host as dedicated to weka. For example it can be rebooted whenever needed, and configured by weka for
